...
class Post(models.Model):
    ...
    # author = models.ForeignKey(Author, on_delete=models.SET_NULL, related_name="posts") # yazar silindiğinde gönderi silinmesin ve yazarla ilişkisini sağlarken tersine çağırırken related_name parametresi posts olsun
